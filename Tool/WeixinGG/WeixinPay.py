# coding:utf-8
# @Explain : 说明
# @Time    : 2018/6/22 下午3:10
# @Author  : gg
# @FileName: WeixinPay.py
...
class WeixinPay(object):
    def __init__(self, bid, app_id, mch_id, mch_key, notify_url, key=None, cert=None):
        self.bid = bid
        self.app_id = app_id
        self.mch_id = mch_id
    ...
    def unified_order(self, **data):
        ...
        if "spbill_create_ip" not in data:
            raise WeixinPayError("spbill_create_ip")
